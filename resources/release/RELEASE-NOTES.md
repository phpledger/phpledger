...
- **Permissions:** membership uses the existing role-ID capability model throughout; migration 056 retires the legacy role ENUM. Owner changes cannot strand a company without an active owner. The fixed public demo identity and executable package controls are protected server-side.
