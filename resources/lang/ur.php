...
return [
    ...
    'Choose date' => 'تاریخ منتخب کریں',
    'Close calendar' => 'کیلنڈر بند کریں',
    'Previous' => 'پچھلا',
    'Next' => 'اگلا',
    'Choose year' => 'سال منتخب کریں',
    'Choose month' => 'مہینہ منتخب کریں',
    'Today' => 'آج',
    'Clear date' => 'تاریخ صاف کریں',
    'Enter a real date in DD/MM/YYYY format.' => 'DD/MM/YYYY کی صورت میں درست تاریخ درج کریں۔',
    'Choose a date within the allowed range.' => 'اجازت دی گئی حد کے اندر تاریخ منتخب کریں۔',
    'Sunday' => 'اتوار',
    'Monday' => 'پیر',
    'Tuesday' => 'منگل',
    'Wednesday' => 'بدھ',
