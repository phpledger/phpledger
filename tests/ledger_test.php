...
test('company setup creates one book, an owner, an annual period and scoped template', function (): void {
    ...
    assert_same(14 + 19, (int) DB::queryFirstField('SELECT COUNT(*) FROM pl_accounts WHERE company_id = %i', $fixture['company_id']));
    assert_same(14, (int) DB::queryFirstField("SELECT COUNT(*) FROM pl_accounts WHERE company_id = %i AND code NOT LIKE '_-___-00000-__'", $fixture['company_id']));
    assert_same(14 + 19 + 6, count($fixture['accounts']));
