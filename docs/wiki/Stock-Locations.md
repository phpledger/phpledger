...
Migration `037_stock_documents` builds a document layer over the movements already described above. Nothing about transfers, carrying value or the default warehouse changes; what is new is numbering, printing and paperwork.
