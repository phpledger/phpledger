...
# The path after 1.1.2

With 1.1.2 published, the release sequence the owner set on 19 September 2026 is (status and dates in the [1.2 release plan](https://github.com/phpledger/phpledger/blob/master/docs/strategy/RELEASE-PLAN-1.2.md)):
