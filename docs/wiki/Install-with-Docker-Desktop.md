...
This recipe installs release **1.4.6**. Its version stays fixed when you restart. It downloads PHP Ledger from GitHub Container Registry and MySQL from Docker Hub automatically.
