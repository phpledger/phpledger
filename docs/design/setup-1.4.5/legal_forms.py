...
COUNTRIES = {
    ...
    'GB': {
        ...
        'forms': [
            ...
            ('clg', 'non_profit', 'Company limited by guarantee, CIC or charity (CIO)', 'No shareholders; members guarantee a nominal sum. CICs and charities have their own regulator too.', 'Companies House or the Charity Commission', 'company or charity number, VAT number if registered'),
            ('other', 'other', 'Other or not sure', 'Pick the closest form; your registration papers or your accountant will say. It can be changed later in Company profile.', 'your registrar', 'the numbers on your registration'),
        ],
    },
    'US': {
    ...
    'AE': {
        ...
        'name': 'United Arab Emirates', 'registrar': 'the Department of Economic Development or the free zone authority',
        ...
        'forms': [
            ('sole_establishment', 'sole_proprietor', 'Sole establishment', 'Owned by one person who is fully liable; licensed by the emirate\'s DED.', 'the DED of your emirate', 'trade licence number, and TRN if registered'),
            ('civil_company', 'partnership', 'Civil company (professional partnership)', 'Partners practising a profession together, with unlimited liability.', 'the DED of your emirate', 'trade licence number, TRN'),
            ('llc', 'llc', 'Limited liability company (LLC, mainland)', 'The usual mainland company; one or more shareholders with limited liability.', 'the DED of your emirate', 'trade licence number, TRN'),
            ...
            ('fzco', 'llc', 'Free zone company (FZCO or FZ-LLC)', 'A free zone company with two or more shareholders.', 'the free zone authority', 'licence number, TRN'),
            ('prjsc', 'private_limited', 'Private joint stock company (PrJSC)', 'Shares held privately; two or more founders and higher capital than an LLC.', 'the Ministry of Economy and the DED', 'licence number, TRN'),
    ...
    'SG': {
        ...
        'forms': [
            ('sole_proprietorship', 'sole_proprietor', 'Sole proprietorship', 'One owner registered with ACRA; the registration is renewed every year.', 'ACRA', 'UEN, and GST number if registered'),
            ('partnership', 'partnership', 'Partnership or limited partnership (LP)', '2 to 20 partners registered with ACRA.', 'ACRA', 'UEN, and GST number if registered'),
    ...
    'ZZ': {
        'default': 'private_limited', 'currency': 'USD', 'fiscal_year_end': '12-31',
