...
|---|---|
| Required accounting core | Companies/books, identities and permissions, chart and mappings, exact money/dates, journals/posting/audit, periods, opening/cutover, cash/bank reconciliation and reports. AR and AP are separately implemented required modules; generic manually configured tax calculation is shared core. From 1.2, the company's legal form and registration profile and the ownership register (owners/members, directors/officers, share classes, share ledger) are core (decision B63, issue #92); statutory forms, certificates and filing calendars are country plugins. |
