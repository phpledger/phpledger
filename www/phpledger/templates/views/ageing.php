...
<div class="table-wrap" tabindex="0" role="region" aria-label="Ageing documents; scroll horizontally on smaller screens"><table class="table"><thead><tr><th>Customer / vendor</th><th>Document</th><th>Due date</th><th>Age</th><th class="text-end">Document balance</th><th class="text-end"><?= pl_e($company['currency']) ?> balance</th></tr></thead><tbody>
...
<details class="panel !m-0" <?= !$report['reconciled']?'open':'' ?>><summary class="section-title">Control-account reconciliation</summary><div class="table-wrap mt-3" tabindex="0" role="region" aria-label="Ageing control account reconciliation"><table class="table"><thead><tr><th>Account</th><th class="text-end">Ledger</th><th class="text-end">Open items</th><th class="text-end">Difference</th></tr></thead><tbody>
