...
<section class="flex flex-col gap-4 py-5" aria-labelledby="employees-title">
    ...
    <div class="rounded-panel border border-border bg-surface p-4" id="employee-form">
        ...
        <form class="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2" method="post" action="<?= pl_e(pl_url('/employees')) ?>">
            ...
            <?php endif; ?>
            <div class="field"><label for="employee-name"><?= pl_e(pl_t('Full name')) ?><?= pl_ui_required_marker() ?></label><input class="input" id="employee-name" name="full_name" maxlength="160" required value="<?= pl_e((string) pl_web_text($input, 'full_name')) ?>"></div>
            ...
            <div class="field"><label for="employee-type"><?= pl_e(pl_t('Employment type')) ?><?= pl_ui_required_marker() ?></label>
            ...
            <div class="field"><label for="employee-status"><?= pl_e(pl_t('Employment status')) ?><?= pl_ui_required_marker() ?></label>
            ...
            <div class="field sm:col-span-2"><label for="employee-reason"><?= pl_e(pl_t('Reason for this change')) ?><?= pl_ui_required_marker() ?></label><input class="input" id="employee-reason" name="reason" maxlength="500" required value="<?= pl_e((string) pl_web_text($input, 'reason')) ?>"></div>
