...
<div class="page-header"><div><h1 class="page-title"><?= pl_e(pl_t('Updates and privacy')) ?></h1><p class="muted"><?= pl_e(pl_t('Check for releases and decide whether to register this installation with the project.')) ?></p></div></div>
...
<p><?= pl_e(pl_t('This copy tells phpledger.com it was installed and when it checks for updates: a random installation ID, application version and channel, PHP version, database engine and version, operating-system family, installation mode, event and time. No database address, credentials, account records or financial data are sent, and nothing here switches it off.')) ?></p>
...
<?php endforeach; ?>
<p class="muted"><?= pl_e(pl_t('Removing registration sends an anonymous notice that replaces the named record; it does not delete earlier submissions. See the privacy page for retention and deletion requests.')) ?> <a href="https://phpledger.com/privacy/"><?= pl_e(pl_t('Privacy')) ?></a></p>
