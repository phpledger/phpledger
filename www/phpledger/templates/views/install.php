...
<?php if ($sharedDemo): ?>
<div class="alert alert-info" id="demo-database-hint" role="note"><p><?= pl_e(pl_t('These are example values for the demo. The real database settings stay private and cannot be changed here. Check database runs the normal connection checks using the server settings.')) ?></p></div>
<div class="field"><label class="field-label" for="public-url"><?= pl_e(pl_t('This site\'s address')) ?></label><input class="input" id="public-url" name="public_url" type="url" value="<?= pl_e(pl_shared_demo_public_url()) ?>" readonly></div>
<div class="field-pair">
<div class="field"><label class="field-label" for="db-host"><?= pl_e(pl_t('Database host')) ?></label><input class="input" id="db-host" name="host" value="db.example.invalid" readonly autocomplete="off" aria-describedby="demo-database-hint"></div>
<div class="field"><label class="field-label" for="db-port"><?= pl_e(pl_t('Port')) ?></label><input class="input" id="db-port" name="port" value="3306" readonly aria-describedby="demo-database-hint"></div>
</div>
<div class="field"><label class="field-label" for="db-name"><?= pl_e(pl_t('Database name')) ?></label><input class="input" id="db-name" name="database" value="example_ledger" readonly autocomplete="off" aria-describedby="demo-database-hint"></div>
<div class="field"><label class="field-label" for="db-user"><?= pl_e(pl_t('Database username')) ?></label><input class="input" id="db-user" name="user" value="example_user" readonly autocomplete="off" aria-describedby="demo-database-hint"></div>
<div class="field"><label class="field-label" for="db-password"><?= pl_e(pl_t('Database password')) ?></label><input class="input" id="db-password" name="password" type="password" value="example-password" readonly autocomplete="off" aria-describedby="demo-database-hint"></div>
<?php else: ?>
...
<div class="field"><label class="field-label" for="db-prefix"><?= pl_e(pl_t('Table prefix')) ?></label><input class="input" id="db-prefix" name="db_prefix" value="<?= pl_e($field('db_prefix', (string) (getenv('PL_DB_PREFIX') ?: 'pl_'))) ?>" required pattern="[a-z][a-z0-9_]{0,15}_" maxlength="17"><p class="field-hint"><?= pl_e(pl_t('Choose a unique prefix for this installation. It cannot be changed after installation. Separate databases remain recommended.')) ?></p></div>
<div class="field"><label class="field-label" for="db-ca"><?= pl_e(pl_t('TLS CA certificate path')) ?></label><input class="input" id="db-ca" name="db_ssl_ca" value="<?= pl_e($field('db_ssl_ca')) ?>" autocomplete="off"><p class="field-hint"><?= pl_e(pl_t('For a cloud database, enter the server-side path to the certificate authority file supplied by your host. Server identity verification stays enabled.')) ?></p></div>
<?php endif; ?>
